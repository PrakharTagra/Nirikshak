    ...
    <div className="flex min-h-screen flex-col bg-govt-cream font-sans">
      ...
      <main className="flex flex-1 items-start justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-6">
            <h1 className="text-xl font-bold text-govt-dark">Set your password</h1>
            <p className="mt-2 text-sm text-slate-600 bg-blue-50 border border-blue-100 p-3 rounded">
              Signed in as <span className="font-semibold">{user?.full_name}</span>. 
              Replace the password you were issued before continuing.
            </p>
          </div>

          <form onSubmit={submit} className="border border-slate-300 bg-white p-6 shadow-sm border-t-[4px] border-t-govt-navy">
            <div>
            ...
            <div className="mt-5">
              <label htmlFor="new_password" className="block text-sm font-medium text-slate-700">New password</label>
              ...
              <p id="pw-hint" className="mt-1.5 text-xs text-slate-500">Must be at least 10 characters long.</p>
