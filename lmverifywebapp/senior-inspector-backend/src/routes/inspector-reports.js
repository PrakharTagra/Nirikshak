...
const submitSchema = z.object({
  ...
  packageRecord: z.any().optional(),
  package_record: z.any().optional(),
...
inspectorReportsRouter.post('/', async (req, res) => {
  ...
  try {
    ...
    const report = await Report.create({
      ...
      packageRecord: data.packageRecord || data.package_record || {},
      package_record: data.package_record || data.packageRecord || {},
