...
async function generateReport({ imagePath, imagePaths, packageRecord, complianceResult, productDir }) {
  ...
  const candidateStage9Paths = [
    path.resolve(__dirname, '../../stage9_reporting/report_generator.py'),
    path.resolve(__dirname, '../../../stage9_reporting/report_generator.py'),
    path.resolve(process.cwd(), 'stage9_reporting/report_generator.py'),
    path.resolve(process.cwd(), 'ComplianceEngine/stage9_reporting/report_generator.py'),
  ];
