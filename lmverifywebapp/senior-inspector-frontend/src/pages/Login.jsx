      ...
      <main id="main-content" className="flex flex-1 items-center justify-center px-4 py-10 md:py-16">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6 flex flex-col items-center">
            ...
            <h2 className="text-base font-semibold text-slate-800 mt-0.5">Assistant Controller of Legal Metrology</h2>
            <p className="text-xs text-slate-600 mt-1">Inspection Review & Statutory Decision System</p>
          </div>
            ...
            <form onSubmit={submit} className="p-6 md:p-8">
              <div>
                ...
                <div className="relative mt-1">
                  <input 
                    ...
                    autoFocus
                    placeholder="Enter assigned AC username"
                    value={form.username} 
              ...
              >
                {busy ? (
                  ...
                  <>
                    <span>Sign In to AC Portal</span>
              ...
              <div className="mt-6 border-t border-slate-200 pt-4">
                <div className="flex items-start gap-2.5 bg-amber-50/80 p-3 rounded border border-amber-200 text-xs text-slate-700 leading-relaxed">
                  ...
                  <div>
                    ...
                    Unauthorized access is strictly prohibited under the Information Technology Act. Accounts are issued by the Controller of Legal Metrology.
                  </div>
                </div>
              </div>
            </form>
