    ...
    content: (
      <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
        ...
        <div>
          ...
          <p>
            Consumers may report misleading declarations, absence of mandatory e-commerce product declarations (MRP, Net Quantity, Country of Origin, Expiry Date, Manufacturer/Packer/Importer Details), and price manipulation on digital marketplaces. DMI reports generated through this portal directly feed enforcement dockets for jurisdictional Assistant Controllers.
          </p>
        </div>
    ...
    content: (
      <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
        ...
        <div>
          ...
          <p>
            For authorized Digital Marketplace Inspectors (DMIs), this system records surveillance timestamps, crawled URL metadata, scraped listing snapshots, OCR inspection evidence, and compliance audit decisions under Section 15 of the Legal Metrology Act, 2009.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-slate-900 mb-1">Data Security &amp; Retention</h4>
          <p>
            All data transmissions are encrypted using Transport Layer Security (TLS 1.3). Digital Marketplace Surveillance dossiers are archived in secured National Informatics Centre (NIC) cloud infrastructure in compliance with the Information Technology Act, 2000 and national data retention norms.
          </p>
        </div>
        <div className="border-t border-slate-200 pt-3 text-[11px] text-slate-500">
      ...
      <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
        <div className="bg-amber-50 border-l-4 border-amber-600 p-3 rounded-r">
          ...
          <p className="text-slate-700 mt-0.5">
            This platform is designated exclusively for appointed Controllers, Assistant Controllers, and authorized Digital Marketplace Inspectors (DMIs).
          </p>
        </div>
        <div>
          <h4 className="font-bold text-slate-900 mb-1">Evidentiary Value</h4>
          <p>
            Automated visual captures, OCR extractions, and compliance evaluations generated through this console carry statutory evidentiary value under the Legal Metrology Act, 2009 and the Indian Evidence Act for proceedings before statutory adjudicating officers.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-slate-900 mb-1">Offenses &amp; Penalties</h4>
          <p>
            Unauthorized access, credential sharing, tampering with automated scan logs, or interfering with market surveillance engines is an offense punishable under Sections 43, 65, and 66 of the Information Technology Act, 2000 and relevant provisions of the Bharatiya Nyaya Sanhita (BNS).
          </p>
        </div>
        <div className="border-t border-slate-200 pt-3 text-[11px] text-slate-500">
    ...
    content: (
      <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
        <div>
          ...
          <p>
            This portal scans and audits public listings on e-commerce platforms (Amazon, Flipkart, Blinkit, Zepto, etc.) as mandated under Rule 6(10) of the Legal Metrology (Packaged Commodities) Rules, 2011. External hyperlinking to merchant products is conducted strictly for regulatory compliance auditing.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-slate-900 mb-1">Permission to Link</h4>
          <p>
            Prior permission is not required to link directly to information hosted on this portal. Pages must load into a newly opened browser window and not within framing partitions on external websites.
          </p>
        </div>
        <div className="border-t border-slate-200 pt-3 text-[11px] text-slate-500">
  ...
  return (
    <>
      <footer className="w-full flex flex-col mt-auto select-none">
        ...
        <div className="bg-govt-dark text-white/85 px-4 md:px-8 py-8 text-xs">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
              ...
              <div className="flex flex-col items-center md:items-end text-center md:text-right gap-1.5">
                ...
                <span className="text-[10px] text-white/50">
                  Digital Marketplace Inspectorate Surveillance Console (NIRIKSHAK)
                </span>
              </div>
            </div>
